...
class MyModule2 : public phpcxx::Module {
public:
    using phpcxx::Module::Module;
...
protected:
    virtual bool moduleStartup() override
    {
        ...
        EXPECT_TRUE(bool_const.registerConstant());
        EXPECT_TRUE(int_const.registerConstant());
        EXPECT_TRUE(long_const.registerConstant());
        EXPECT_TRUE(double_const.registerConstant());
        EXPECT_TRUE(float_const.registerConstant());
        EXPECT_TRUE(null_const.registerConstant());
        EXPECT_TRUE(string_const.registerConstant());
        EXPECT_TRUE(string_const2.registerConstant());
        EXPECT_FALSE(duplicate.registerConstant());
